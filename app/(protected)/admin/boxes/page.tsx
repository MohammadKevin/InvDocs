              ...
              >
                {editingBox && (
                  <div className="space-y-3">
                    ...
                    <input
                      disabled
                      value={editingBox.kode_box}
                      className="w-full px-8 py-5 bg-slate-100 dark:bg-slate-900 rounded-[2rem] text-sm font-bold border-2 border-transparent outline-none opacity-70"
                    />
                  </div>
                )}
