                                        ...
                                        {[
                                            ...
                                            (item) => (
                                                <button
                                                    ...
                                                    className={`px-5 py-3 rounded-2xl text-xs font-black uppercase tracking-widest transition-all ${chartRange ===
                                                            item.key
